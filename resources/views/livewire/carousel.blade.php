<div class="carousel relative shadow-2x1 bg-gray-100">
    <div class="carousel-inner relative overflow-hidden w-full">
        ...
        <div class="carousel-item absolute opacity-0" style="height: 50vh;">
            <img src="{{ asset('images/1.jpg') }}" class="object-fill h-full w-full">
        </div>
		...
		<div class="carousel-item absolute opacity-0" style="height:50vh;">
			<img src="{{ asset('images/2.jpg') }}" class="object-fill h-full w-full">
		</div>
		...
		<div class="carousel-item absolute opacity-0" style="height:50vh;">
			<img src="{{ asset('images/3.jpg') }}" class="object-fill h-full w-full">
		</div>
